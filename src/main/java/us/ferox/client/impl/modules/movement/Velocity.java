...
public class Velocity extends Module {
    ...
    public static NumberSetting<Float> horizontal = new NumberSetting<>("Horizontal", 0.0f, 0.0f, 100.0f);
    public static NumberSetting<Float> vertical = new NumberSetting<>("Vertical", 0.0f, 0.0f, 100.0f);
